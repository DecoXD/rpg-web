          ...
          <li key={skill.id} className="flex  gap-2  p-2 font-medieval border-b-[1px] border-amber-300/50">
            ...
            <div className="flex flex-col gap-2 ">
                ...
                <div className="flex gap-2">
                  ...
                  <p className="text-[10px] font-medieval">BASE:<span className="font-bold">{skill.skillBaseDamage}</span></p>
                  ...
                  <p className="text-[10px] font-bold font-medieval">
                    <span 
                      className={` ${clsx({
                    'text-red-500':skill.supportType === 'DEBUFF',
                    'text-green-700':skill.supportType === 'BUFF'
                      })}`}>
                      {skill.supportType}
                    </span>
                  </p> 
...
export default SupportSkillsContainer